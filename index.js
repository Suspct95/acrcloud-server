...
// Pour que Render comprenne les JSON dans les requêtes POST
app.use(express.json());

// GET simple pour éviter l'erreur 404 sur /identify
app.get('/identify', (req, res) => {
  res.send('Cette route attend une requête POST avec un fichier audio');
});

// POST pour recevoir le fichier audio et faire l’identification via ACRCloud
